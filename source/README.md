...
| `enrich.ps1` | Adds base stats (Gen-6-corrected), vanilla abilities (2 regular + hidden), TM/HM compatibility, and move info (type/category/power/accuracy/PP/description + hack changes). |
...
| `pokemon_stats.csv`, `pokemon_abilities.csv`, `ability_names.csv`, `machines.csv`, `move_names.csv`, `moves.csv`, `type_names.csv` | PokeAPI data (stats, abilities, TM/HM machines, move names, move stats, type names). |
